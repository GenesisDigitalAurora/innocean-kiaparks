    ...
    descriptionsSet: [
        {
            descTextEsp: [
                ...
                '<h2>Zona de Descanso</h2><p>Requería una limpieza profunda y una renovación importante para atraer a más visitantes.</p>',
        ...
        },
        {
            descTextEsp: [
                ...
                '<h2>Zona de Descanso</h2><p>Se readecuaron las áreas de picnic, para inspirar los mejores momentos.</p>',
            ...
            descTextEng: [
                ...
                '<h2>Soccer Bleachers Fields</h2><p>We gave maintenance to the grass of one of the fields and in both we placed new nets. Signage and a hydration area were placed near both.</p>',
                '<h2>Soccer Fields</h2><p>Maintenance was given and a new design was placed on the stands and more life to the grass.</p>',
                '<h2>Volleyball Court</h2><p>The court was painted again, we maintained its surroundings and soon a net will be placed to play.</p>',
